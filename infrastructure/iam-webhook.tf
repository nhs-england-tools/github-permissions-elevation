...
resource "aws_iam_role" "github_permission_manager_webhook" {
  name               = "${terraform.workspace}_AssumeLambdaRole_github_permission_manager_webhook"
...
resource "aws_iam_policy" "function_logging_policy_github_permission_manager_webhook" {
  name        = "${terraform.workspace}_AllowLambdaLoggingPolicy_github_permission_manager_webhook"
