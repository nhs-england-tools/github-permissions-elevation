locals {
  github_permission_manager_webhook_function_name = "${terraform.workspace}_github_permission_manager_webhook"
  ...
  github_permission_manager_demotion_function_name = "${terraform.workspace}_github_permission_manager_demotion"
